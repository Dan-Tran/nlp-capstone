"""
This file is used with preyolo.py to prep object detection

The paths set in the constants below, must be updated before the script can run
"""
...
class Yolo:
    def __init__(self):
        self.net = load_net(YOLO_CONFIG.encode(), YOLO_WEIGHTS.encode(), 0)
        self.meta = load_meta(META_FILE.encode())
